...
| systemd | [systemd/systemd](https://github.com/systemd/systemd) | [Issue #40974](https://github.com/systemd/systemd/issues/40974) | discussion | Shifts the debate from `birthDate` to `ageGroup`, indicating ongoing schema design for age signaling | Softens wording without rejecting the category of functionality |
...
| Ubuntu desktop provisioning | [canonical/ubuntu-desktop-provision](https://github.com/canonical/ubuntu-desktop-provision) | [PR #1338](https://github.com/canonical/ubuntu-desktop-provision/pull/1338) | draft | Adds `birthDate` to provisioning flow and links the Ubuntu path to upstream account and portal work | Wires the implementation path into Ubuntu user setup |
